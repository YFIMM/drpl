...
const Demolitionist = ({onClickTheChamp}) => {
    const {demolitionist, champNameToKOR, trait} = useSelector(state => state.traits);
    return (
        <>
            <div id="폭파광" style={{margin: "10px"}}>
