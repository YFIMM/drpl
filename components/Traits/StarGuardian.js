...
const StarGuardian = ({onClickTheChamp}) => {
    const {starGuardian, champNameToKOR, trait} = useSelector(state => state.traits);
    return (
        <>
            <div id="별수호자" style={{margin: "10px"}}>
                <div style={{width: "86px", height: "86px", float: "left"}}>
                    <p style={{
                        ...
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["별수호자"] >= 3 ? 1 : 0.3}`,
                            color: "white"
                        }}>(3)</span>
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["별수호자"] >= 6 ? 1 : 0.3}`,
                            color: "white"
                        }}>(6)</span>
                    </p>
                </div>
