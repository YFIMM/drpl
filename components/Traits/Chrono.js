...
const Chrono = ({onClickTheChamp}) => {
    const {chrono, champNameToKOR, trait} = useSelector(state => state.traits);
    return (
        <>
            <div id="시공간" style={{margin: "10px"}}>
                <div style={{width: "86px", height: "86px", float: "left"}}>
                    <p style={{
                        ...
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["시공간"] >= 2 ? 1 : 0.3}`,
                            color: "white"
                        }}>(2)</span>
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["시공간"] >= 4 ? 1 : 0.3}`,
                            color: "white"
                        }}>(4)</span>
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["시공간"] >= 6 ? 1 : 0.3}`,
                            color: "white"
                        }}>(6)</span>
                    </p>
                </div>
