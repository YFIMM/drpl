...
const Vanguard = ({onClickTheChamp}) => {
    const {vanguard, champNameToKOR, trait} = useSelector(state => state.traits);
    return (
        <>
            <div id="선봉대" style={{margin: "10px"}}>
                <div style={{width: "86px", height: "86px", float: "left"}}>
                    <p style={{
                        ...
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["선봉대"] >= 2 ? 1 : 0.3}`,
                            color: "white"
                        }}>(2)</span>
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["선봉대"] >= 4 ? 1 : 0.3}`,
                            color: "white"
                        }}>(4)</span>
                    </p>
                </div>
