...
const Mystic = ({onClickTheChamp}) => {
    const {mystic, champNameToKOR, trait} = useSelector(state => state.traits);
    return (
        <>
            <div id="신비술사" style={{margin: "10px"}}>
                <div style={{width: "86px", height: "86px", float: "left"}}>
                    <p style={{
                        ...
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["신비술사"] >= 2 ? 1 : 0.3}`,
                            color: "white"
                        }}>(2)</span>
                        <span style={{
                            fontSize: "16px",
                            opacity: `${trait["신비술사"] >= 4 ? 1 : 0.3}`,
                            color: "white"
                        }}>(4)</span>
                    </p>
                </div>
